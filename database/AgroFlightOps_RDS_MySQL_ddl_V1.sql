-- ============================================================================
-- Sistema de Gestão de Serviços de Pulverização por Drones "AgroFlightOps" - MySQL DDL
-- Compatível com Amazon RDS for MySQL 8.0 / Aurora MySQL
-- Origem: conversão do DDL PostgreSQL para MySQL
-- ============================================================================
...
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `agroflightops` DEFAULT CHARACTER SET utf8 ;
USE `agroflightops` ;
...
CREATE TABLE historico_status_missao (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
...
CREATE TABLE consumos_insumo_missao (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
    missao_id BIGINT UNSIGNED NOT NULL,
    insumo_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE checklists_missao (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
...
CREATE TABLE itens_checklist_missao (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
...
CREATE TABLE financeiro_missao (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
    missao_id BIGINT UNSIGNED NOT NULL UNIQUE,
